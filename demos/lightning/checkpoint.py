...
class ModelBoxLightningCheckpointPlugin(CheckpointIO):

    def __init__(self, upload_checkpoints: bool) -> None:
        super().__init__()
    ...
    def save_checkpoint(self, checkpoint: Dict[str, Any], path: _PATH, storage_options: Optional[Any] = None) -> None:
        ...
        path = os.path.join("/tmp/modelboxchk", path) 
    ...
    def load_checkpoint(self, path: _PATH, storage_options: Optional[Any] = None) -> Dict[str, Any]:
        ...
        log.info("Diptanu called load_checkpoint")
